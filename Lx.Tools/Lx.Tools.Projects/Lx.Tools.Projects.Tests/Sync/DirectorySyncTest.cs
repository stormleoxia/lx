...
namespace Lx.Tools.Projects.Tests.Sync
{
    ...
    public class DirectorySyncTest
    {
        ...
        {
            Mock<IFileSystem> fileSystem = new Mock<IFileSystem>(MockBehavior.Strict);
            ...
            Mock<ISyncFactory> factory = new Mock<ISyncFactory>(MockBehavior.Strict);
            ...
            DirectorySync directorySync = new DirectorySync("path", factory.Object, fileSystem.Object);
